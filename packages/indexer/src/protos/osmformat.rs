...
pub struct Info {
    ...
    user_sid: ::std::option::Option<i32>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl Info {
    ...
    // Param is passed by value, moved
    pub fn set_user_sid(&mut self, v: i32) {
...
pub struct ChangeSet {
    ...
    closetime_delta: ::std::option::Option<i64>,
...
impl ChangeSet {
    ...
    pub fn get_closetime_delta(&self) -> i64 {
        self.closetime_delta.unwrap_or(0)
    }
    pub fn clear_closetime_delta(&mut self) {
        self.closetime_delta = ::std::option::Option::None;
    }

    pub fn has_closetime_delta(&self) -> bool {
        self.closetime_delta.is_some()
    }

    // Param is passed by value, moved
    pub fn set_closetime_delta(&mut self, v: i64) {
        self.closetime_delta = ::std::option::Option::Some(v);
    }
...
impl ::protobuf::Message for ChangeSet {
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                9 => {
                    ...
                    let tmp = is.read_int64()?;
                    self.closetime_delta = ::std::option::Option::Some(tmp);
                },
                10 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(v) = self.closetime_delta {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_vec_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                "keys",
                |m: &ChangeSet| { &m.keys },
                |m: &mut ChangeSet| { &mut m.keys },
            ));
            fields.push(::protobuf::reflect::accessor::make_vec_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                "vals",
                |m: &ChangeSet| { &m.vals },
                |m: &mut ChangeSet| { &mut m.vals },
            ));
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<Info>>(
                "info",
                |m: &ChangeSet| { &m.info },
                |m: &mut ChangeSet| { &mut m.info },
            ));
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<_, ::protobuf::types::ProtobufTypeInt64>(
                "created_at",
                |m: &ChangeSet| { &m.created_at },
                |m: &mut ChangeSet| { &mut m.created_at },
            ));
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<_, ::protobuf::types::ProtobufTypeInt64>(
                "closetime_delta",
                |m: &ChangeSet| { &m.closetime_delta },
                |m: &mut ChangeSet| { &mut m.closetime_delta },
            ));
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<_, ::protobuf::types::ProtobufTypeBool>(
                "open",
                |m: &ChangeSet| { &m.open },
                |m: &mut ChangeSet| { &mut m.open },
            ));
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<HeaderBBox>>(
                "bbox",
                |m: &ChangeSet| { &m.bbox },
                |m: &mut ChangeSet| { &mut m.bbox },
            ));
...
impl Relation {
    ...
    // repeated .Relation.MemberType types = 10;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0fosmformat.proto\"\xae\x03\n\x0bHeaderBlock\x12!\n\x04bbox\x18\x01\
    \x20\x01(\x0b2\x0b.HeaderBBoxR\x04bboxB\0\x12-\n\x11required_features\
    \x18\x04\x20\x03(\tR\x10requiredFeaturesB\0\x12-\n\x11optional_features\
    \x18\x05\x20\x03(\tR\x10optionalFeaturesB\0\x12(\n\x0ewritingprogram\x18\
    \x10\x20\x01(\tR\x0ewritingprogramB\0\x12\x18\n\x06source\x18\x11\x20\
    \x01(\tR\x06sourceB\0\x12D\n\x1dosmosis_replication_timestamp\x18\x20\
    \x20\x01(\x03R\x1bosmosisReplicationTimestampB\0\x12O\n#osmosis_replicat\
    ion_sequence_number\x18!\x20\x01(\x03R\x20osmosisReplicationSequenceNumb\
    erB\0\x12A\n\x1cosmosis_replication_base_url\x18\"\x20\x01(\tR\x19osmosi\
    sReplicationBaseUrlB\0:\0\"j\n\nHeaderBBox\x12\x14\n\x04left\x18\x01\x20\
    \x02(\x12R\x04leftB\0\x12\x16\n\x05right\x18\x02\x20\x02(\x12R\x05rightB\
    \0\x12\x12\n\x03top\x18\x03\x20\x02(\x12R\x03topB\0\x12\x18\n\x06bottom\
    \x18\x04\x20\x02(\x12R\x06bottomB\0:\0\"\xa3\x02\n\x0ePrimitiveBlock\x12\
    0\n\x0bstringtable\x18\x01\x20\x02(\x0b2\x0c.StringTableR\x0bstringtable\
    B\0\x129\n\x0eprimitivegroup\x18\x02\x20\x03(\x0b2\x0f.PrimitiveGroupR\
    \x0eprimitivegroupB\0\x12'\n\x0bgranularity\x18\x11\x20\x01(\x05:\x03100\
    R\x0bgranularityB\0\x12\"\n\nlat_offset\x18\x13\x20\x01(\x03:\x010R\tlat\
    OffsetB\0\x12\"\n\nlon_offset\x18\x14\x20\x01(\x03:\x010R\tlonOffsetB\0\
    \x121\n\x10date_granularity\x18\x12\x20\x01(\x05:\x041000R\x0fdateGranul\
    arityB\0:\0\"\xcb\x01\n\x0ePrimitiveGroup\x12\x1d\n\x05nodes\x18\x01\x20\
    \x03(\x0b2\x05.NodeR\x05nodesB\0\x12#\n\x05dense\x18\x02\x20\x01(\x0b2\
    \x0b.DenseNodesR\x05denseB\0\x12\x1a\n\x04ways\x18\x03\x20\x03(\x0b2\x04\
    .WayR\x04waysB\0\x12)\n\trelations\x18\x04\x20\x03(\x0b2\t.RelationR\tre\
    lationsB\0\x12,\n\nchangesets\x18\x05\x20\x03(\x0b2\n.ChangeSetR\nchange\
    setsB\0:\0\"\x1f\n\x0bStringTable\x12\x0e\n\x01s\x18\x01\x20\x03(\x0cR\
    \x01sB\0:\0\"\x99\x01\n\x04Info\x12\x1e\n\x07version\x18\x01\x20\x01(\
    \x05:\x02-1R\x07versionB\0\x12\x1e\n\ttimestamp\x18\x02\x20\x01(\x05R\tt\
    imestampB\0\x12\x1e\n\tchangeset\x18\x03\x20\x01(\x03R\tchangesetB\0\x12\
    \x12\n\x03uid\x18\x04\x20\x01(\x05R\x03uidB\0\x12\x1b\n\x08user_sid\x18\
    \x05\x20\x01(\x05R\x07userSidB\0:\0\"\xa4\x01\n\tDenseInfo\x12\x1c\n\x07\
    version\x18\x01\x20\x03(\x05R\x07versionB\x02\x10\x01\x12\x20\n\ttimesta\
    mp\x18\x02\x20\x03(\x12R\ttimestampB\x02\x10\x01\x12\x20\n\tchangeset\
    \x18\x03\x20\x03(\x12R\tchangesetB\x02\x10\x01\x12\x14\n\x03uid\x18\x04\
    \x20\x03(\x11R\x03uidB\x02\x10\x01\x12\x1d\n\x08user_sid\x18\x05\x20\x03\
    (\x11R\x07userSidB\x02\x10\x01:\0\"\xf1\x01\n\tChangeSet\x12\x10\n\x02id\
    \x18\x01\x20\x02(\x03R\x02idB\0\x12\x16\n\x04keys\x18\x02\x20\x03(\rR\
    \x04keysB\x02\x10\x01\x12\x16\n\x04vals\x18\x03\x20\x03(\rR\x04valsB\x02\
    \x10\x01\x12\x1b\n\x04info\x18\x04\x20\x01(\x0b2\x05.InfoR\x04infoB\0\
    \x12\x1f\n\ncreated_at\x18\x08\x20\x02(\x03R\tcreatedAtB\0\x12)\n\x0fclo\
    setime_delta\x18\t\x20\x01(\x03R\x0eclosetimeDeltaB\0\x12\x14\n\x04open\
    \x18\n\x20\x02(\x08R\x04openB\0\x12!\n\x04bbox\x18\x0b\x20\x01(\x0b2\x0b\
    .HeaderBBoxR\x04bboxB\0:\0\"\x8f\x01\n\x04Node\x12\x10\n\x02id\x18\x01\
    \x20\x02(\x12R\x02idB\0\x12\x16\n\x04keys\x18\x02\x20\x03(\rR\x04keysB\
    \x02\x10\x01\x12\x16\n\x04vals\x18\x03\x20\x03(\rR\x04valsB\x02\x10\x01\
    \x12\x1b\n\x04info\x18\x04\x20\x01(\x0b2\x05.InfoR\x04infoB\0\x12\x12\n\
    \x03lat\x18\x08\x20\x02(\x12R\x03latB\0\x12\x12\n\x03lon\x18\t\x20\x02(\
    \x12R\x03lonB\0:\0\"\x9b\x01\n\nDenseNodes\x12\x12\n\x02id\x18\x01\x20\
    \x03(\x12R\x02idB\x02\x10\x01\x12*\n\tdenseinfo\x18\x05\x20\x01(\x0b2\n.\
    DenseInfoR\tdenseinfoB\0\x12\x14\n\x03lat\x18\x08\x20\x03(\x12R\x03latB\
    \x02\x10\x01\x12\x14\n\x03lon\x18\t\x20\x03(\x12R\x03lonB\x02\x10\x01\
    \x12\x1f\n\tkeys_vals\x18\n\x20\x03(\x05R\x08keysValsB\x02\x10\x01:\0\"~\
    \n\x03Way\x12\x10\n\x02id\x18\x01\x20\x02(\x03R\x02idB\0\x12\x16\n\x04ke\
    ys\x18\x02\x20\x03(\rR\x04keysB\x02\x10\x01\x12\x16\n\x04vals\x18\x03\
    \x20\x03(\rR\x04valsB\x02\x10\x01\x12\x1b\n\x04info\x18\x04\x20\x01(\x0b\
    2\x05.InfoR\x04infoB\0\x12\x16\n\x04refs\x18\x08\x20\x03(\x12R\x04refsB\
    \x02\x10\x01:\0\"\x89\x02\n\x08Relation\x12\x10\n\x02id\x18\x01\x20\x02(\
    \x03R\x02idB\0\x12\x16\n\x04keys\x18\x02\x20\x03(\rR\x04keysB\x02\x10\
    \x01\x12\x16\n\x04vals\x18\x03\x20\x03(\rR\x04valsB\x02\x10\x01\x12\x1b\
    \n\x04info\x18\x04\x20\x01(\x0b2\x05.InfoR\x04infoB\0\x12\x1f\n\troles_s\
    id\x18\x08\x20\x03(\x05R\x08rolesSidB\x02\x10\x01\x12\x1a\n\x06memids\
    \x18\t\x20\x03(\x12R\x06memidsB\x02\x10\x01\x12.\n\x05types\x18\n\x20\
    \x03(\x0e2\x14.Relation.MemberTypeR\x05typesB\x02\x10\x01\"/\n\nMemberTy\
    pe\x12\x08\n\x04NODE\x10\0\x12\x07\n\x03WAY\x10\x01\x12\x0c\n\x08RELATIO\
    N\x10\x02\x1a\0:\0B\0b\x06proto2\
";
